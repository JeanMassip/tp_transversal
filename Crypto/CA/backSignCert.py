...
def fillcertificate(one_day,ISSUER_NAME,COMMON_NAME,COUNTRY_NAME,LOCALITY_NAME,STATE_NAME,ORGANIZATION_NAME,ORGANIZATIONAL_UNIT_NAME):
...
certificatebuilder=fillcertificate(one_day,ISSUER_NAME,COMMON_NAME,COUNTRY_NAME,LOCALITY_NAME,STATE_NAME,ORGANIZATION_NAME,ORGANIZATIONAL_UNIT_NAME)
