...
# messages MQTT a un vehicule pair
##############################################
...
def main(argv):
    ...
    # On envoie le certificat du vehicule
    # sur le endpoint du vehicule pair

    Vehicule_url="http://urlvehicule:5000/auth"
    ...
    # Si le vehicule renvoie un OK, alors
    # le certificat est valide et on peut
    # envoyer les messages MQTT
